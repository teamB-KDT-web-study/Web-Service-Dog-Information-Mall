      ...
      <div className="Training">
        <div className="trainingContainer">
          <div className="cards">
            <article className="information [ card ]">
              <span className="tag">
                <span>추천수 {mostLikeList[0].like_count}</span>
                <span className="view">
                  조회수 {mostLikeList[0].view_count}
                </span>
              </span>
          ...
          <div className="cards">
            <article className="information [ card ]">
              <span className="tag">
                <span>추천수 {mostLikeList[1].like_count}</span>
                <span className="view">
                  조회수 {mostLikeList[1].view_count}
                </span>
              </span>
        ...
        <div className="trainingContainer">
          <div className="cards">
            <article className="information [ card ]">
              <span className="tag">
                <span>추천수 {mostLikeList[2].like_count}</span>
                <span className="view">
                  조회수 {mostLikeList[2].view_count}
                </span>
              </span>
          ...
          <div className="cards">
            <article className="information [ card ]">
              <span className="tag">
                <span>추천수 {mostLikeList[3].like_count}</span>
                <span className="view">
                  조회수 {mostLikeList[3].view_count}
                </span>
              </span>
